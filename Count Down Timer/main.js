    ...
    return inquirer.prompt([
        {
            type: "number",
            name: "hours",
            message: chalk.bold.yellowBright("Please enter the amount of hours"),
            validate: (input) => {
                if (isNaN(input)) {
        ...
        },
        {
            type: "number",
            name: "minutes",
            message: chalk.bold.yellowBright("Please enter the amount of minutes"),
            validate: (input) => {
                if (isNaN(input)) {
                    return "Please enter a valid number";
                }
        ...
        },
        {
            type: "number",
            name: "seconds",
            message: chalk.bold.yellowBright("Please enter the amount of seconds"),
            validate: (input) => {
                if (isNaN(input)) {
                    return "Please enter a valid number";
                }
...
function printBigNumber(hours, minutes, seconds) {
    ...
    for (let i = 0; i < hour1Digits.length; i++) {
        console.log(chalk.bold.blueBright(hour1Digits[i].padEnd(12) + hour2Digits[i].padEnd(12)) +
